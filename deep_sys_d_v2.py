...
OPTIONAL_PACKAGES = {
    ...
    'safety': 'safety',  # Vulnerability scanning
    ...
    def check_and_install():
        ...
        if missing_packages:
            ...
            try:
                ...
                subprocess.check_call([sys.executable, "-m", "pip", "install", "--quiet", "--user"] + missing_packages,
                ...
                print_status("Failed to install dependencies. Install manually with: pip install --user " +
                             " ".join(missing_packages), "ERROR")
                sys.exit(1)

        # Try to import required modules
        try:
            global psutil, requests, jinja2, markdown
            import psutil
            import requests
            import jinja2
            import markdown
            ...
            print_status("Try installing manually: pip install --user psutil requests Jinja2 markdown cryptography",
                         "ERROR")
            sys.exit(1)
...
class HTMLReportGenerator:
    ...
    def generate_report(data: Dict[str, Any], output_path: str = None) -> str:
        ...
        try:
            # Create template with safe syntax
            ...
            # Try fallback simple template
            return HTMLReportGenerator._generate_simple_report(report_data, output_path)
    ...
    def _get_template() -> str:
        """Get HTML template with hacker theme - FIXED TEMPLATE"""
        return """<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="section">
        <div class="section-header">
            ...
            <div style="color: #00aa00">Live connections monitored</div>
        </div>
    ...
    <div class="section">
        <div class="section-header">
            ...
            <div style="color: #00aa00">Memory and behavior analysis</div>
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="font-size: 0.9em; color: #00aa00">
    ...
    <div class="section">
        <div class="section-header">
            ...
            <div style="color: #00aa00">System security assessment</div>
        </div>
    ...
    <div class="section">
        <div class="section-header">
            ...
            <div style="color: #00aa00">Recent system events</div>
        </div>
        ...
        <div class="timeline">
            ...
            <div class="timeline-item {{ event.importance|lower }}">
                <div style="display: flex; justify-content: space-between; margin-bottom: 5px;">
                    ...
                    <span style="color: #00aa00">{{ event.time }}</span>
                </div>
                <div style="color: #00aa00; font-size: 0.9em">{{ event.details }}</div>
    ...
    <div class="footer">
        ...
        <div style="margin-top: 10px; font-size: 0.8em; color: #00aa00">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            setInterval(function() {
                document.querySelectorAll('.risk-high').forEach(function(el) {
    ...
    @staticmethod
    def _generate_simple_report(data: Dict[str, Any], output_path: str) -> str:
...
<head>
    ...
    <style>
        ...
        .card {{ background: #111; border: 1px solid #333; padding: 15px; margin: 10px 0; }}
        .high {{ color: #ff0000; }}
        .medium {{ color: #ffff00; }}
        .low {{ color: #00ff00; }}
    </style>
...
<body>
    <h1>HACKERVISION SECURITY REPORT</h1>
    <p>Generated: {datetime.now().strftime("%Y-%m-%d %H:%M:%S")}</p>

    <div class="card">
        <h2>Summary</h2>
        <p>Total Threats: {data['summary']['total_threats']}</p>
        <p>High Threats: {data['summary']['high_threats']}</p>
        <p>Risk Score: {data['summary']['risk_score']}/100</p>
    </div>

    <div class="card">
        <h2>Network Traffic</h2>
        <p>Monitored {len(data['network_traffic'])} connections</p>
    </div>

    <div class="card">
        <h2>Suspicious Processes</h2>
        <p>Found {len(data['suspicious_processes'])} suspicious processes</p>
    </div>
</body>
</html>"""
...
def main():
    ...
    print_status("Version 2.1 | Author: Security Analyst", "SYSTEM")
    print_status("=" * 60, "SYSTEM")
