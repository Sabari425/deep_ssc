            ...
            html_content += f'''
                        <tr>
                            ...
                            <td class="url-cell" title="{cred['target']}">
                                ...
                                {cred['target'][:50]}{'...' if len(cred['target']) > 50 else ''}
                            </td>
                            <td>
    ...
    html_content += f'''
            ...
            <footer class="footer">
                <div class="security-warning">
                    <i class="fas fa-exclamation-triangle" style="color: var(--danger-red); font-size: 1.5rem; margin-right: 10px;"></i>
                    <div style="text-align: left; display: inline-block;">
                        <h3 style="color: var(--danger-red); margin-bottom: 5px;">SECURITY WARNING</h3>
                        <p style="color: var(--hacker-green); margin: 0;">
                            This report contains highly sensitive credential information.<br>
                            Store securely, encrypt if necessary, and delete when no longer needed.
                        </p>
                    </div>
                </div>

                <div style="margin: 20px 0; color: var(--hacker-green-light);">
                    <p><i class="fas fa-file-contract"></i> Report generated by Browser Credential Auditor v2.0</p>
                    <p style="font-size: 0.9rem; margin-top: 10px;">
                        <i class="fas fa-save"></i> Report saved to: <code style="background: rgba(0, 255, 0, 0.1); padding: 2px 5px; border-radius: 3px;">{report_path}</code>
                    </p>
                </div>

                <div style="margin-top: 25px; padding-top: 20px; border-top: 1px solid rgba(0, 255, 0, 0.1);">
                    <p style="color: var(--hacker-green-light); font-size: 0.85rem;">
                        <i class="fas fa-info-circle"></i> For educational and security audit purposes only.<br>
